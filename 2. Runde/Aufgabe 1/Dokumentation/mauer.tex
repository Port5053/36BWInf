...
\\\\
Im Anhang Abbildung (\ref{fig:kollisionen}) wird die Kollisionshäufigkeit genauer statistisch untersucht. Die Beobachtungen unterstützen die obigen Vorhersagen.
\newpage
...
\end{align*}
\footnotetext{$\tau = 2\pi$ \qquad (\emph{siehe} \href{https://tauday.com/tau-manifesto}{\url{https://tauday.com/tau-manifesto}})}
