...
Um nach jedem Schritt die Ordnung der Reihen zu erhalten, wird die aufgefüllte Reihe an das Ende der Reihenfolge gesetzt. Nachdem das ich
\newpage
\section{Anhang}
\begin{algorithm}[H]
	\DontPrintSemicolon
